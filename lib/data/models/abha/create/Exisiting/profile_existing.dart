...
class ProfileExisting {
  ...
  ProfileExisting.fromJson(dynamic json) {
    _sCode = json['sCode'];
  ...
  String? _sMessage;
  SData? _sData;
ProfileExisting copyWith({  num? sCode,
  String? sMessage,
  SData? sData,
}) => ProfileExisting(  sCode: sCode ?? _sCode,
...
/// preferredAbhaAddress : "91113084360800@sbx"
/// mobile : "9702713057"
/// mobileVerified : true
/// firstName : "Rohit"
/// middleName : "Mohan"
...
/// authMethods : ["AADHAAR_BIO","AADHAAR_OTP","MOBILE_OTP","DEMOGRAPHICS"]
/// tags : []
/// kycVerified : true
...
/// status_code : 200
/// request-id : "0a4db865-8e29-4b26-b74a-c0f2b7cfc197"
/// iIsLinked : false
...
class SData {
  ...
  String? _requestid;
  bool? _iIsLinked;
SData copyWith({  String? aBHANumber,
  String? preferredAbhaAddress,
  String? mobile,
  bool? mobileVerified,
  String? firstName,
  ...
  String? requestid,
  bool? iIsLinked,
}) => SData(  aBHANumber: aBHANumber ?? _aBHANumber,
