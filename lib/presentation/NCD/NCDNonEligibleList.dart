...
/// A screen to display a list of households not eligible for NCD,
/// with search functionality and an option to register a new household.
class Ncdnoneligiblelist extends StatefulWidget {
  const Ncdnoneligiblelist({super.key});

  @override
  State<Ncdnoneligiblelist> createState() => _NCDHomeState();
}

class _NCDHomeState extends State<Ncdnoneligiblelist> {
