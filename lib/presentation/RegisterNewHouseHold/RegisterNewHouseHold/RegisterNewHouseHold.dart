...
class _RegisterNewHouseHoldScreenState extends State<RegisterNewHouseHoldScreen>
  ...
  Future<void> _handleAppBarBackTap() async {
    if (_skipExitConfirm) {
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  color: Colors.white,
                  child: const Text(
                    'If you go back, detail will be lost, Do you want to go back',
                    style: TextStyle(
                      color: Color(0xFFD32F2F),
                      fontSize: 16.0,
                    ),
      ...
      String mapValue(String key, dynamic value) {
        ...
        switch (key) {
          ...
          case 'toiletType':
            ...
            if (lower == 'pit toilet with running water supply')
              return 'Pit toilet with running water supply';
