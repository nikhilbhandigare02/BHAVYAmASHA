...
class _AddNewFamilyMemberScreenState extends State<AddNewFamilyMemberScreen>
        ...
        if (_isMemberDetails && hhIdArg.isNotEmpty) {
          try {
            ...
            if (rc != null) {
              ...
              final headOtherReligion = (rc['other_religion'] ?? '').toString();
              final headCategory = (rc['category'] ?? '').toString();
              final headOtherCategory = (rc['other_category'] ?? '').toString();
              ...
              if (headCategory.isNotEmpty &&
                ...
                _bloc.add(
                  AnmUpdateCategory(_mapCategoryToMember(headCategory)),
                );
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.inlineEdit &&
      ...
      if (otherReligion.isNotEmpty)
        b.add(AnmUpdateOtherReligion(otherReligion));
      ...
      if (otherCategory.isNotEmpty)
        b.add(AnmUpdateOtherCategory(otherCategory));

      // Banking / IDs / ABHA
      final bankAcc =
          (data['bankAcc'] ?? data['bankAccountNumber'] ?? '') as String;
      ...
      final rationId =
          (data['rationId'] ?? data['rationCardId'] ?? '') as String;
        ...
        if (spLmp != null) {
          ...
          WidgetsBinding.instance.addPostFrameCallback((_) {
            if (mounted) {
              ...
              print(
                '🔄 [AddNewMember] EDIT - Spouse LMP change event sent after frame callback',
              );
            }
          });
        } else {
          print(
            '❌ [AddNewMember] EDIT - Failed to parse spouse LMP: "$spLmpIso"',
          );
        }
      } else {
        ...
        if (spEdd != null) {
          ...
          WidgetsBinding.instance.addPostFrameCallback((_) {
            if (mounted) {
              ...
              print(
                '🔄 [AddNewMember] EDIT - Spouse EDD change event sent after frame callback',
              );
            }
          });
        } else {
          print(
            '❌ [AddNewMember] EDIT - Failed to parse spouse EDD: "$spEddIso"',
          );
        }
      } else {
                              ...
                              child: Column(
                                children: [
                                  _section(
                                    ApiDropdown<String>(
                                      ...
                                      onChanged: (v) {
                                        ...
                                        final currentMemberType =
                                            state.memberType;

                                        print(
                                          '🔄 [MemberType] Changing from: $currentMemberType to: $v',
                                        );
                                        print(
                                          '🔄 [MemberType] Current state - Name: ${state.name}, Mobile: ${state.mobileNo}',
                                        );
                                        print(
                                          '🔄 [MemberType] Data cleared flag: $_dataClearedByTypeChange',
                                        );

                                        if ((currentMemberType == 'Adult' &&
                                                v == 'Child') ||
                                            (currentMemberType == 'Child' &&
                                                v == 'Adult')) {
                                          print(
                                            '🧹 [MemberType] Clearing all data due to member type change',
                                          );
                                          setState(() {
                                          ...
                                          Future.microtask(() {
                                            bloc.add(
                                              AnmUpdateMemberType(v ?? ''),
                                            );
                                            bloc.add(AnmResetDataClearedFlag());
                                            print(
                                              '🔄 [MemberType] Set new member type after clearing: $v',
                                            );
                                          });
                                        } else {
                                          bloc.add(
                                        ...
                                        print(
                                          '🔄 [MemberType] After change - MemberType: ${state.memberType}, Name: ${state.name}',
                                        );
                                      },
                                      validator: (value) => _captureAnmError(
                                        Validations.validateMemberType(
                                          l,
                                          value,
                                        ),
                                      ),
                                  ...
                                  if (_isEdit) ...[
                                    _section(
                                      ApiDropdown<String>(
                                        labelText: l.member_status_label,
                                        ...
                                        _section(
                                          CustomTextField(
                                            ...
                                            onChanged: (v) => context
                                                .read<AddnewfamilymemberBloc>()
                                                .add(
                                                  UpdateOtherDeathPlace(
                                                    v ?? '',
                                                  ),
                                                ),
                                            validator: (value) {
                                              if (state.memberStatus ==
                                                      'Death' &&
                                  ...
                                  if ((state.memberType ?? '').toLowerCase() ==
                                    ...
                                    _section(
                                      ApiDropdown<String>(
                                        ...
                                        items: _getchildMobileOwnerList(
                                          state.gender ?? '',
                                        ),
                                        getLabel: (s) {
                                          switch (s) {
                                        ...
                                        onChanged: (v) async {
                                          ...
                                          if (v == 'Family Head' ||
                                            ...
                                            if (v == 'Mother') {
                                              if (widget.headSpouseMobile !=
                                                      null &&
                                                  widget
                                                      .headSpouseMobile!
                                                      .isNotEmpty) {
                                                mobileNumber =
                                                    widget.headSpouseMobile;
                                                print(
                                                  '📱 [AddNewMember] Using spouse mobile from props: $mobileNumber',
                                                );
                                              ...
                                              mobileNumber =
                                                  widget.headMobileNumber;
                                              print(
                                                '📱 [AddNewMember] Using head mobile from props: $mobileNumber',
                                              );
                                              shouldFetchFromDb = false;
                                            }
                                            ...
                                            if (shouldFetchFromDb &&
                                              ...
                                              try {
                                                if (v == 'Mother') {
                                                  mobileNumber =
                                                      await LocalStorageDao
                                                          .instance
                                                          .getSpouseMobileNumber(
                                                            widget.hhId!,
                                                          );
                                                  print(
                                                    '📱 [AddNewMember] Fetched spouse mobile from DB: $mobileNumber',
                                                  );
                                                } else {
                                                  mobileNumber =
                                                      await LocalStorageDao
                                                  ...
                                                  print(
                                                    '📱 [AddNewMember] Fetched head mobile from DB: $mobileNumber',
                                                  );
                                                }
                                              } catch (e) {
                                                print(
                                                  '❌ Error fetching mobile number: $e',
                                                );
                                              }
                                            }
                                            ...
                                            if (mobileNumber != null &&
                                              ...
                                              print(
                                                '📱 [AddNewMember] Setting mobile number: $mobileNumber for $v',
                                              );
                                              bloc.add(
                                                AnmUpdateMobileNo(mobileNumber),
                                              );
                                    ...
                                    if (state.mobileOwner == 'Other')
                                      _section(
                                        CustomTextField(
                                          ...
                                          hintText:
                                              l?.enter_relation_with_mobile_holder ??
                                        ...
                                        CustomTextField(
                                          ...
                                          validator: (value) {
                                            ...
                                            if (parsed < 1200 ||
                                                parsed > 4000) {
                                              return _captureAnmError(
                                                l?.birth_weight_range_validation ??
                                  ...
                                  if (state.ChildSchool == 'Yes' ||
                                      state.ChildSchool == "yes") ...[
                                    Divider(
                                      color: AppColors.divider,
                                      thickness: 0.5,
                                      height: 0,
                                    ...
                                    _section(
                                      ApiDropdown<String>(
                                        ...
                                        items: const ['Government', 'Private'],
                                        getLabel: (s) {
                                          switch (s) {
                                            case 'Government':
                                              return l.government;
                                                ...
                                                SizedBox(
                                                  ...
                                                  child: RoundButton(
                                                    ...
                                                    onPress: () async {
                                                      ...
                                                      debugPrint(
                                                        "BACK FROM ABHA LINK SCREEN (New Member)",
                                                      );
                                                      debugPrint(
                                                        "RESULT: $result",
                                                      );
                                      ...
                                      _section(
                                        ApiDropdown<String>(
                                          ...
                                          onChanged: (v) {
                                            ...
                                            if (v == 'No') {
                                              bloc.add(
                                                const AnmLMPChange(null),
                                              );
                                              bloc.add(
                                                const AnmEDDChange(null),
                                              );
                                            }
                                          },
                                          validator: (value) {
                                        ...
                                        _section(
                                          ApiDropdown<String>(
                                            ...
                                            validator: (value) {
                                              if (value == null ||
                                                  value == l.select) {
                                                return l?.please_select_family_planning_status ??
                                      ...
                                      child: RoundButton(
                                        ...
                                        onPress: () async {
                                          ...
                                          if (!_isEdit &&
                                            ...
                                            final isValid = formState
                                                .validate();
                                            if (!isValid) {
                                              final msg =
                                                  _anmLastFormError ??
                                                  l?.pleaseCorrectErrors ??
                                          ...
                                          try {
                                            ...
                                            if (state.maritalStatus
                                              ...
                                              print(
                                                '👫 [AddNewMember] Adding spouse details - spouse name: ${state.spouseName}',
                                              );
                                              // Get spouse data from SpousBloc
                                              final spouseState =
                                                  _spousBloc.state;
                                              print(
                                                '💑 [AddNewMember] Spouse state - useDob: ${spouseState.useDob}, dob: ${spouseState.dob}, approxAge: ${spouseState.approxAge}',
                                              );

                                              // Calculate spouse age
                                              String calculatedSpouseAge = '';
                                              if (spouseState.useDob == true &&
                                                  spouseState.dob != null) {
                                                try {
                                                  final now = DateTime.now();
                                                  ...
                                                  calculatedSpouseAge = years
                                                      .toString();
                                                  print(
                                                    '🎂 [AddNewMember] Spouse age calculated from DOB: $calculatedSpouseAge (DOB: $dob)',
                                                  );
                                                } catch (_) {
                                                  calculatedSpouseAge =
                                                      spouseState.approxAge ??
                                                      '';
                                                  print(
                                                    '❌ [AddNewMember] Error calculating spouse age from DOB, using approx: $calculatedSpouseAge',
                                                  );
                                                }
                                              } else {
                                                calculatedSpouseAge =
                                                    spouseState.approxAge ?? '';
                                                print(
                                                  '📅 [AddNewMember] Spouse age from approximate: $calculatedSpouseAge',
                                                );
                                              }

                                              final spouseDetailsData = {
                                                'relation':
                                                    spouseState.relation ??
                                                    'spouse',
                                                'memberName':
                                                    spouseState.memberName,
                                                'ageAtMarriage':
                                                    spouseState.ageAtMarriage,
                                                'RichIDChanged':
                                                    spouseState.RichIDChanged,
                                                'spouseName':
                                                    spouseState.spouseName ??
                                                    state
                                                        .name, // Original member's name
                                                'fatherName':
                                                    spouseState.fatherName,
                                                ...
                                                'is_family_planning':
                                                    ...
                                                    : 0,
                                                'fpMethod':
                                                    spouseState.fpMethod,
                                                'removalDate': spouseState
                                                    .removalDate
                                                    ?.toIso8601String(),
                                                'removalReason':
                                              ...
                                              print(
                                                '💾 [AddNewMember] Final spousedetails data: $spouseDetailsData',
                                              );
                                              memberData['spousedetails'] =
                                                  spouseDetailsData;
                                            } else {
                                              print(
                                                '❌ [AddNewMember] Not married or no spouse name - maritalStatus: ${state.maritalStatus}, spouseName: ${state.spouseName}',
                                              );
                                            }
