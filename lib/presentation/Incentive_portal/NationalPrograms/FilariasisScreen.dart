...
class FilariasisScreen extends StatelessWidget {
  const FilariasisScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => FilariasisBloc(),
      child: BlocBuilder<FilariasisBloc, FilariasisState>(
        builder: (context, state) {
          final bloc = context.read<FilariasisBloc>();
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                    ...
                                    child: CustomTextField(
                                      ...
                                      onChanged: (val) =>
                                          bloc.add(UpdateFilariasisField(i, val)),
                                    ),
                                  ),
                                ],
                              ),
