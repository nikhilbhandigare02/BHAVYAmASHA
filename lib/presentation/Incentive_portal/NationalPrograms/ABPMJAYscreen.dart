...
class ABPMJAYScreen extends StatelessWidget {
  const ABPMJAYScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => AbpmjayBloc(),
      child: BlocBuilder<AbpmjayBloc, AbpmjayState>(
        builder: (context, state) {
          final bloc = context.read<AbpmjayBloc>();
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            // ✅ Single Question (same layout as other programs)
