...
class AESJEScreen extends StatelessWidget {
  const AESJEScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => AesJeBloc(),
      child: BlocBuilder<AesJeBloc, AesJeState>(
        builder: (context, state) {
          final bloc = context.read<AesJeBloc>();
              ...
              child: SingleChildScrollView(
                child: Card(
                  ...
                  child: Column(
                    ...
                    children: [
                      // ✅ Header same as TB Program design
                      Container(
