...
class _HbncVisitScreenState extends State<HbncVisitScreen>
  ...
  Widget build(BuildContext context) {
    ...
    print(
      ('from screen form', beneficiaryData?['child_tab_count'] as int?) ?? 1,
    );
              ...
              listener: (context, state) {
                ...
                if (state.saveSuccess && !state.isSaving) {
                  ...
                  if (mounted) {
                    ...
                    final int visitDay = dayRaw is int
                        ? dayRaw
                      ...
                      if (!_navigationTriggered) {
                        ...
                        CustomDialog.show(
                          ...
                          onOkPressed: () {
                            ...
                            final shouldReturn =
                                (widget.beneficiaryData
                                    as Map?)?['returnToPrevious'] ==
                                true;
                            if (shouldReturn) {
                  ...
                  AppHeader(
                    ...
                    onIcon1Tap: () {
                      final beneficiaryData =
                          (widget as dynamic).beneficiaryData;
                      final beneficiaryId =
                    ...
                    child: IgnorePointer(
                      ...
                      child: TabBar(
                        ...
                        tabs: [
                          ...
                          ...List.generate(
                            _childCount,
                            (i) => Tab(text: '${t.tabNewbornDetails} ${i + 1}'),
                          ),
                        ],
                      ),
                    ),
                          ...
                          ...List.generate(
                            ...
                            (i) => ChildDetailsTab(
                              beneficiaryId:
                                  ...
                                  '',
                              childTabCount:
                                  (beneficiaryData?['child_tab_count']
                                      as int?) ??
                                  1,
                              childIndex: i + 1,
                            ),
  ...
  String _mapErrorCodeToText(AppLocalizations t, String code) {
    final m = <String, String>{
      ...
      'err_post_delivery_problems_required':
      ...
      'err_foul_discharge_high_fever_required':
          t.err_foul_discharge_high_fever_required,
      'err_abnormal_speech_or_seizure_required':
          t.err_abnormal_speech_or_seizure_required,
      'err_counseling_advice_required': t.err_counseling_advice_required,
      'err_milk_not_producing_or_less_required':
          t.err_milk_not_producing_or_less_required,
      'err_nipple_cracks_pain_or_engorged_required':
          t.err_nipple_cracks_pain_or_engorged_required,
      ...
      'err_other_reason_of_death_required':
          t.err_other_reason_of_death_required,
      ...
      'err_mother_reports_temp_or_chest_indrawing_required':
          t.err_mother_reports_temp_or_chest_indrawing_required,
      'err_bleeding_umbilical_cord_required':
          t.err_bleeding_umbilical_cord_required,
      ...
      'err_congenital_abnormalities_required':
          t.err_congenital_abnormalities_required,
      ...
      'err_crying_constant_or_less_urine_required':
          t.err_crying_constant_or_less_urine_required,
      ...
      'err_birth_certificate_issued_required':
          t.err_birth_certificate_issued_required,
      'err_birth_dose_vaccination_required':
          t.err_birth_dose_vaccination_required,
      'err_mcp_child_required': t.err_mcp_child_required,
      'err_exclusive_breastfeeding_started_required':
          t.err_exclusive_breastfeeding_started_required,
      'err_first_breastfeed_timing_required':
          t.err_first_breastfeed_timing_required,
      'err_how_was_breastfed_required': t.err_how_was_breastfed_required,
      'err_first_feed_given_after_birth_required':
          t.err_first_feed_given_after_birth_required,
      'err_adequately_fed_seven_eight_required':
          t.err_adequately_fed_seven_eight_required,
      'err_baby_drinking_less_milk_required':
          t.err_baby_drinking_less_milk_required,
      'err_breastfeeding_stopped_required':
          t.err_breastfeeding_stopped_required,
      'err_bloated_or_frequent_vomit_required':
          t.err_bloated_or_frequent_vomit_required,
    };
    return m[code] ?? code;
  }
}
